...
$sql = "select ud.today_diamond,u.* FROM user_temple_data_record ud LEFT JOIN user_info u ON ud.user_id=u.user_id where $sql1 and ud.today_diamond>0 order by ud.today_diamond DESC LIMIT $shownum";
echo $sql;
$res = mysql_query($sql, $conn2);
