                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="" id="addUserForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">   										
										<?php if(is_array($user_js)): $i = 0; $__LIST__ = $user_js;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="user_js" value="<?php echo ($vo["id"]); ?>" > <?php echo ($vo["js_name"]); ?> &nbsp;&nbsp;&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
