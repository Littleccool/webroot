            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <?php if($caozuo["add"] == 1): ?><a class="btn btn-primary btn-sm" href="<?php echo U('User/power_add');?>"><i class="fa fa-plus"></i> 添加操作</a><?php endif; ?>
                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($vo["power_do"]); ?></td>
                                            <td><?php echo ($vo["addtime"]); ?></td>
                                            <td><?php if($caozuo["edit"] == 1): ?><a href="<?php echo U('User/power_edit','id='.$vo['id']);?>">修改操作</a><?php endif; ?>&nbsp;<?php if($caozuo["del"] == 1): ?><a onclick="return confirm('您确定删除该纪录吗？')" href="<?php echo U('User/power_delete','id='.$vo['id']);?>">删除操作</a><?php endif; ?></td>
