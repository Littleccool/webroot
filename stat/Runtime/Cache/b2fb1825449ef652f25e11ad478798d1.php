	...
	<div id="page-wrapper">
        ...
        <!-- /.row -->
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
				uid
					<input  name="uid" style="height:30px;" size="20">
        ...
        <div class="row">
            ...
            width="100%">
								<thead>
                                <tr>
									<th width="50" colspan="2">玩家信息</th>
                                </tr>
                                </thead>
                                <tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr> <td>游戏名称</td><td><?php echo ($vo["gameName"]); ?></td></tr>
								<tr> <td>玩家昵称</td><td><?php echo ($vo["name"]); ?></td></tr>
                                <!-- <tr> <td>玩家id</td><td><?php echo ($vo["wxId"]); ?></td></tr> -->
                                <tr> <td>游戏id</td><td><?php echo ($vo["uid"]); ?></td></tr>
                                <tr> <td>充值金额</td><td><?php echo ($vo["rmb"]); ?></td></tr>
                                <tr> <td>剩余钻石</td><td><?php echo ($vo["balance"]); ?></td></tr>
                                <tr> <td>注册时间</td><td><?php echo ($vo["regDate"]); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                 </tbody>
                            </table>
                        </div>
                    </div>
