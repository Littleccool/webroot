            ...
            width="100%" style="table-layout:fixed">
                                ...
                                <tbody>
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td><?php echo ($vo["allUser"]); ?></td>
                                            <td><?php echo ($vo["newUser"]); ?></td>
                                            <td><?php echo ($vo["bindCount"]); ?></td>
											<td><?php echo ($vo["dau"]); ?></td>
                                            <td><?php echo ($vo["dou"]); ?></td>
                                            <td><?php echo ($vo["fee"]); ?></td>
											<td><?php echo ($vo["feeCount"]); ?></td>
                                            <td><?php echo ($vo["feeRate"]); ?>%</td>
                                            <td><?php echo ($vo["arpu"]); ?></td>
											<td><?php echo ($vo["cash"]); ?></td>
											<td><?php echo ($vo["juShu"]); ?></td>
											<td><?php echo ($vo["jieSuanJuShu"]); ?></td>
