            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <?php if($caozuo["add"] == 1): ?><a class="btn btn-primary btn-sm" href="<?php echo U('User/user_add');?>"><i class="fa fa-plus"></i> 添加操作员</a><?php endif; ?>
                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($vo["jsname"]); ?></td>
                                            <td><?php echo ($vo["card_num"]); ?></td>
                                            <td><?php echo ($vo["status"]); ?></td>
                                            <td><?php echo ($vo["created_at"]); ?></td>
                                            <td><?php if($vo["del"] == 1): if($caozuo["edit"] == 1): ?><a href="<?php echo U('User/user_edit','id='.$vo['id']);?>">修改操作员</a><?php endif; ?>&nbsp;<?php if($caozuo["del"] == 1): ?><a onclick="return confirm('您确定删除该纪录吗？')" href="<?php echo U('User/user_delete','id='.$vo['id']);?>">删除操作员</a><?php endif; endif; ?></td>
