                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="" id="addUserForm">
                            ...
                            <div class="form-group">
                                <label for="username" class="col-sm-2 control-label">代理等级</label>
                                <div class="col-sm-4">
                                    <select name="level" style="height:30px;">
							...
							<div class="form-group">
                                <label for="gameid" class="col-sm-2 control-label">游戏内id</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="uid" name="uid" placeholder="必填">
                                </div>
                            </div>
							<div class="form-group">
                                <label for="phone" class="col-sm-2 control-label">手机号</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="phoneNum" name="phoneNum" placeholder="必填" >
                                </div>
                            </div>
							<div class="form-group">
                                <label for="weiChat" class="col-sm-2 control-label">微信</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="weixin" name="weixin" placeholder="必填" >
                                </div>
                            </div>
							<div class="form-group">
                                <label for="leaderId" class="col-sm-2 control-label">上级代理id</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="leaderId" name="leaderId" placeholder="必填" >
                                </div>
                            </div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" id="addUserSubmit" class="btn btn-primary">申请</button>
                                </div>
                            </div>
                        </form>
                    </div>
